...
<style>
	...
	#userBoardList>#myBoardsAndComments>*:hover{
		cursor: pointer;
		
	}			

	#userBoardList>#myBoardsAndComments>input{
		display: none;
	}

	#userBoardList>#myBoardsAndComments>input:checked+label{
...
>>>>>>> 07f531a54f0a1f75c6372eb20c6b1b2dfaa04415
</style>
...
<body>
	...
	<div class="mainSection">
		...
		<div class="noticeMain">
			<span>공지</span>
			<span><a href="">전체 게시판 공통 규정 (23.10.31)</a></span>
		</div>
		<div class="main">
			...
			<div class="userInfo" align="center">
				...
				<div id="userBoardList">
					<div id="myBoardsAndComments">
						<input type="radio" name="listSwitchBtn" id="boardList" checked>
                        <label for="boardList">작성글</label>
                        <input type="radio" name="listSwitchBtn" id="commentList">
	...
	<script>
		...
		function switchBtn(){
			const myBoards = document.querySelector("#myBoardsAndComments>#myBoards");
			const myComments = document.querySelector("#myBoardsAndComments>#myComments");
		}
	</script>
</body>
</html>